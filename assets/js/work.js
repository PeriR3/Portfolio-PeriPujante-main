...
document.addEventListener('DOMContentLoaded', function() {
    const images = [
        ...
        { class: 'pic11', fullSrc: './assets/imgs/BLOGIMBANNER.jpg' },
        ...
        { class: 'pic15', fullSrc: './assets/imgs/DOBBANNER.jpg' },
        ...
        { class: 'pic20', fullSrc: './assets/imgs/PortadaMRory.jpg' },
...
if (isMobileDevice()) {
    alert("La web a�n no est� disponible para m�viles");
